    ...
    <main style={{fontFamily:"'Plus Jakarta Sans', sans-serif",maxWidth:'1100px',margin:'0 auto'}}>
      ...
      <section style={{padding:'56px 48px 48px'}}>
        <div style={{display:'flex',alignItems:'center',gap:'8px',marginBottom:'24px'}}>
          ...
          <span style={{color:'#e8a020',fontSize:'11px',fontWeight:'600',letterSpacing:'0.14em',textTransform:'uppercase'}}>About</span>
        </div>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(280px, 1fr))',gap:'8px'}}>
          {principles.map((item,i) => (
            <div key={i} style={{backgroundColor:'rgba(255,255,255,0.02)',border:'1px solid rgba(255,255,255,0.05)',borderRadius:'8px',padding:'20px'}}>
              ...
              <p style={{color:'rgba(255,255,255,0.35)',fontSize:'12px',lineHeight:'1.6'}}>{item.text}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{padding:'0 48px 48px'}}>
        <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'24px'}}>
          <div style={{flex:1,height:'1px',background:'rgba(255,255,255,0.07)'}}></div>
          <span style={{color:'rgba(255,255,255,0.25)',fontSize:'10px',fontWeight:'600',letterSpacing:'0.14em',textTransform:'uppercase'}}>Founding partners</span>
          <div style={{flex:1,height:'1px',background:'rgba(255,255,255,0.07)'}}></div>
        </div>
            ...
            <a key={i} href={founder.linkedin} target="_blank" rel="noreferrer" style={{textDecoration:'none',display:'block'}}>
              <div style={{backgroundColor:'rgba(255,255,255,0.02)',border:'1px solid rgba(255,255,255,0.07)',borderRadius:'10px',overflow:'hidden'}}>
                ...
                <div style={{padding:'16px'}}>
                  <p style={{color:'rgba(255,255,255,0.3)',fontSize:'9px',fontWeight:'600',letterSpacing:'0.1em',textTransform:'uppercase',marginBottom:'10px',minHeight:'24px'}}>{founder.capability}</p>
                  ...
                  <p style={{color:'rgba(255,255,255,0.35)',fontSize:'11px',lineHeight:'1.6',marginBottom:'12px'}}>{founder.credential}</p>
                  <p style={{color:'#e8a020',fontSize:'11px',fontWeight:'600'}}>View LinkedIn →</p>
                </div>
              </div>
            </a>
          ))}
        ...
        <div style={{backgroundColor:'rgba(255,255,255,0.02)',border:'1px solid rgba(255,255,255,0.07)',borderRadius:'8px',padding:'20px 24px'}}>
          <p style={{color:'#f0ede6',fontSize:'13px',fontWeight:'700',marginBottom:'4px'}}>Extended Operating Team</p>
          <p style={{color:'rgba(255,255,255,0.35)',fontSize:'12px',lineHeight:'1.6'}}>US GTM Engine is supported by a global operating team of more than 100 professionals across market intelligence, research, and go-to-market execution.</p>
        </div>
      </section>
