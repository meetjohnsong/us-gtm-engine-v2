  ...
  return (
    <main style={{fontFamily:"'Plus Jakarta Sans', sans-serif",maxWidth:'1100px',margin:'0 auto'}}>
      ...
      <section style={{padding:'0 64px 48px'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.50)',fontSize:'14px',fontStyle:'italic',textAlign:'center'}}>We are built to finish, not to embed. The goal is a portfolio company running its own US go-to-market with confidence — on a timeline the operating partner can underwrite.</p>
      </section>
