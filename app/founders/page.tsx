    ...
    <main style={{fontFamily:"'Plus Jakarta Sans', sans-serif",maxWidth:'1100px',margin:'0 auto'}}>
      ...
      <section style={{padding:'56px 48px 48px'}}>
        <div style={{display:'flex',alignItems:'center',gap:'8px',marginBottom:'24px'}}>
          ...
          <span style={{color:'#e8a020',fontSize:'11px',fontWeight:'600',letterSpacing:'0.14em',textTransform:'uppercase'}}>For International B2B Founders & CEOs</span>
        </div>
        ...
        <p style={{color:'rgba(255,255,255,0.4)',fontSize:'14px',lineHeight:'1.7',maxWidth:'520px',marginBottom:'0'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'48px',alignItems:'center'}}>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:'12px'}}>
            {['Fractional CRO','Fractional CMO','Sales Intelligence Analyst','Content Strategist','SDR'].map((role,i) => (
              <div key={i} style={{display:'flex',alignItems:'center',gap:'12px',padding:'12px 16px',backgroundColor:'rgba(255,255,255,0.03)',borderRadius:'6px',border:'1px solid rgba(255,255,255,0.05)'}}>
                <div style={{width:'6px',height:'6px',background:'#e8a020',borderRadius:'50%',flexShrink:0}}></div>
                <span style={{color:'#f0ede6',fontSize:'13px',fontWeight:'600'}}>{role}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{padding:'0 48px 48px'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.3)',fontSize:'13px',fontStyle:'italic',textAlign:'center',marginBottom:'0'}}>We do not lock you in. We earn the next quarter.</p>
      </section>
